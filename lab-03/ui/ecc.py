...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_title.setGeometry(QtCore.QRect(220, 10, 200, 31))
        font = QtGui.QFont()
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(230, 50, 131, 28))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.label_info = QtWidgets.QLabel(self.centralwidget)
        self.label_info.setGeometry(QtCore.QRect(30, 90, 121, 16))
        self.label_info.setObjectName("label_info")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(30, 110, 541, 91))
        self.txt_info.setObjectName("txt_info")
        self.label_sign = QtWidgets.QLabel(self.centralwidget)
        self.label_sign.setGeometry(QtCore.QRect(30, 210, 121, 16))
        self.label_sign.setObjectName("label_sign")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(30, 230, 541, 91))
        self.txt_sign.setObjectName("txt_sign")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(150, 350, 93, 28))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(350, 350, 93, 28))
